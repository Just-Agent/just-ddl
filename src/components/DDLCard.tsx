...
const sourcePreviewRules: Array<[RegExp, string]> = [
  ...
  [/hackzurich\.com/i, 'hackzurich.jpg'],
  [/hackmit\.org/i, 'hackmit.jpg'],
  [/hackharvard\.io/i, 'hackharvard.jpg'],
  [/hackprinceton\.com/i, 'hackprinceton.jpg'],
  [/spaceappschallenge\.org/i, 'space-apps.jpg'],
  [/lahacks\.com/i, 'lahacks.jpg'],
  [/hackupc\.com/i, 'hackupc.jpg'],
  [/calhacks\.io/i, 'calhacks.jpg'],
  [/hackjunction\.com/i, 'hackjunction.jpg'],
  [/treehacks\.com/i, 'treehacks.jpg'],
  [/nwhacks\.io/i, 'nwhacks.jpg'],
  [/hackcambridge\.com/i, 'hackcambridge.jpg'],
  ...
  [/ubicomp\.org/i, 'ubicomp.jpg'],
  [/iscaconf\.org/i, 'isca-conf.jpg'],
  [/icaps-conference\.org/i, 'icaps.jpg'],
  [/icml\.cc/i, 'icml.jpg'],
  [/roboticsconference\.org/i, 'rss.jpg'],
  [/sigir\.org/i, 'sigir.jpg'],
  [/usenix\.org\/conferences/i, 'usenix-conferences.jpg'],
  [/kdd\.org/i, 'kdd.jpg'],
  [/acmmm\.org/i, 'acmmm.jpg'],
  ...
  [/tianchi\.aliyun\.com\/competition/i, 'tianchi.jpg'],
  [/icpc\.global/i, 'icpc.jpg'],
  [/atcoder\.jp/i, 'atcoder.jpg'],
  [/adventofcode\.com/i, 'adventofcode.jpg'],
  [/dasai\.lanqiao\.cn/i, 'lanqiao.jpg'],
  [/usaco\.org/i, 'usaco.jpg'],
  [/codechef\.com\/contests/i, 'codechef-contests.jpg'],
  [/projecteuler\.net/i, 'projecteuler.jpg'],
  [/topcoder\.com\/challenges/i, 'topcoder-challenges.jpg'],
  ...
  [/seccon\.jp/i, 'seccon.jpg'],
  [/zerodayinitiative\.com/i, 'zerodayinitiative.jpg'],
  [/blackhat\.com/i, 'blackhat.jpg'],
  [/hackerone\.com\/hacktivity/i, 'hackerone-hacktivity.jpg'],
  [/rwc\.iacr\.org/i, 'rwc-iacr.jpg'],
  ...
  [/numfocus\.org\/programs\/small-development-grants/i, 'numfocus-grants.jpg'],
  [/github\.com\/cncf\/mentoring/i, 'cncf-mentoring.jpg'],
  [/communityovercode\.org/i, 'communityovercode.jpg'],
  [/us\.pycon\.org/i, 'pycon-us.jpg'],
  [/openssf\.org/i, 'openssf.jpg'],
  [/summit\.fossasia\.org/i, 'fossasia-summit.jpg'],
  ...
  [/igf\.com/i, 'igf.jpg'],
  [/unrealengine\.com/i, 'unreal-engine.jpg'],
  [/amaze-berlin\.de/i, 'amaze-berlin.jpg'],
  [/indiecade\.com/i, 'indiecade.jpg'],
  [/gamesforchange\.org/i, 'gamesforchange.jpg'],
  ...
  [/www8\.cao\.go\.jp\/chosei\/shukujitsu/i, 'japan-cabinet-holidays.jpg'],
  ...
  [/gov\.cn/i, 'gov-cn.jpg'],
  [/earthday\.org/i, 'earthday.jpg'],
  [/yz\.chsi\.com\.cn/i, 'chsi-yz.jpg'],
  [/cet\.neea\.edu\.cn/i, 'neea-cet.jpg'],
  [/ielts\.neea\.cn/i, 'ielts-neea.jpg'],
  [/toefl\.neea\.cn/i, 'toefl-neea.jpg'],
  [/ets\.org\/gre/i, 'ets-gre.jpg'],
  [/mba\.com\/exams\/gmat-exam/i, 'gmac-gmat.jpg'],
  [/ntce\.neea\.edu\.cn/i, 'ntce-neea.jpg'],
  [/ncre\.neea\.edu\.cn/i, 'ncre-neea.jpg'],
  [/ruankao\.org\.cn/i, 'ruankao.jpg'],
  [/moj\.gov\.cn/i, 'moj-cn.jpg'],
  [/aws\.amazon\.com\/certification/i, 'aws-certification.jpg'],
  [/cfainstitute\.org/i, 'cfa-institute.jpg'],
  [/drivendata\.org\/competitions/i, 'drivendata.jpg'],
  [/2026\.emnlp\.org/i, 'emnlp-2026.jpg'],
  [/clpsych\.org/i, 'clpsych.jpg'],
  [/tcci\.ccf\.org\.cn/i, 'tcci-ccf.jpg'],
  [/blackboxnlp\.github\.io/i, 'blackboxnlp.jpg'],
  [/mrqa\.github\.io/i, 'mrqa.jpg'],
  [/naacl\.org/i, 'naacl.jpg'],
  [/conll\.org/i, 'conll.jpg'],
  [/sigtyp\.github\.io/i, 'sigtyp.jpg'],
  [/sigdial\.org/i, 'sigdial.jpg'],
  [/visualqa\.org/i, 'visualqa.jpg'],
  [/textvqa\.org/i, 'textvqa.jpg'],
  [/mmmu-benchmark\.github\.io/i, 'mmmu-benchmark.jpg'],
  [/cocodataset\.org/i, 'coco-dataset.jpg'],
  [/video-mme\.github\.io/i, 'video-mme.jpg'],
  [/github\.com\/vis-nlp\/ChartQA/i, 'chartqa-github.jpg'],
  [/rrc\.cvc\.uab\.es/i, 'docvqa-rrc.jpg'],
  [/opencompass\.org\.cn\/leaderboard-multimodal/i, 'opencompass-multimodal.jpg'],
  [/llava-vl\.github\.io/i, 'llava-vl.jpg'],
  [/2077ai\.com\/challenge-pages\/challenges/i, 'ai-2077-challenges.jpg'],
  [/videoworldmodel-workshop\.github\.io/i, 'video-world-model-workshop.jpg'],
  [/scannetpp\.mlsg\.cit\.tum\.de/i, 'scannetpp.jpg'],
  [/gigaai-research\.github\.io\/GigaBrain-Challenge-2026/i, 'giga-brain-challenge.jpg'],
  [/mmfm-biomed\.github\.io/i, 'mmfm-biomed.jpg'],
  [/ai4va-cvpr\.github\.io/i, 'ai4va-cvpr.jpg'],
  [/agriculture-vision\.com/i, 'agriculture-vision.jpg'],
  [/cvlai\.net\/ntire\/2026/i, 'ntire-2026.jpg'],
  [/ivl\.cs\.brown\.edu\/4dworldmodels/i, '4d-world-models.jpg'],
  [/cv4animals\.com/i, 'cv4animals.jpg'],
  [/image-matching-workshop\.github\.io/i, 'image-matching-workshop.jpg'],
  [/embodied-reasoning\.github\.io/i, 'embodied-reasoning.jpg'],
  [/eecs\.uq\.edu\.au\/CVPR2026/i, 'cvpr-eecs-uq.jpg'],
  [/ai-benchmark\.com\/workshops\/mai\/2026/i, 'mobile-ai-workshop.jpg'],
  [/coop-intelligence\.github\.io/i, 'coop-intelligence.jpg'],
  [/pvuw\.github\.io/i, 'pvuw.jpg'],
  [/cvpr2026ug2challenge\.github\.io/i, 'ug2-challenge.jpg'],
  [/vidgen-bench-eval\.github\.io/i, 'vidgen-bench-eval.jpg'],
  [/vizwiz\.org\/workshops\/2026-vizwiz/i, 'vizwiz.jpg'],
  [/esportsnationscup\.com/i, 'esports-nations-cup.jpg'],
...
function sourceLabelFor(item: DDLItem) {
  ...
  if (source && !/(curated|coverage|seed|demo|official-style|allconfs-style|sinoconf-style)/i.test(source)) {
    return source;
  }
  try {
...
function AwaitingNoticeBadge() {
  ...
  return (
    <span className="inline-flex self-start rounded-full bg-amber-50 px-3 py-1 text-xs font-black text-amber-700">
      {copy.ddl.awaitingNotice}
    </span>
  );
}
