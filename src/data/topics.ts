...
export const topics: Topic[] = [
  ...
  { id: 'academic-ddl', name: 'Academic', description: '跨学科学术会议、基金申请、暑校与科研项目截止日', icon: 'GraduationCap', color: '#F43F5E', repo: 'Just-Agent/academic-ddl', site: 'https://just-agent.github.io/academic-ddl/', status: 'demo', itemCount: 8, category: '学术科研', tags: ['conference', 'grant', 'paper'] },
  { id: 'journal-ddl', name: 'Journal CFP', description: '期刊 Special Issue、Special Section、专题征稿与 Call for Papers 截止日', icon: 'BookOpen', color: '#0F766E', repo: 'Just-Agent/journal-ddl', site: 'https://just-agent.github.io/journal-ddl/', status: 'demo', itemCount: 16, category: '学术期刊', tags: ['journal', 'special issue', 'CFP'] },
