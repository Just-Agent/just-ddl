...
export const topics: Topic[] = [
  ...
  { id: 'journal-ddl', name: 'Journal CFP', description: '期刊 Special Issue、Special Section、专题征稿与 Call for Papers 截止日', icon: 'BookOpen', color: '#0F766E', repo: 'Just-Agent/journal-ddl', site: 'https://just-agent.github.io/journal-ddl/', status: 'published', itemCount: 144, category: '学术期刊', tags: ['journal', 'special issue', 'CFP'] },
