...
export const ddlData: Record<string, DDLItem[]> = {
  ...
  "car-launch-ddl": [
    ...
    },
    {
      ...
      "stage": "Forecast window",
      "source": "Auto Shanghai official history",
      "sourceUrl": "https://www.autoshanghai.org/",
      "canonicalUrl": "https://www.autoshanghai.org/#auto-shanghai-cadence",
      "type": "forecastWindow",
      "subtopic": "auto-show",
      "subtopicName": "国际车展",
      "sourceLabel": "预测窗口",
    ...
    },
    {
      ...
      "url": "https://www.autoshanghai.org/",
      "status": "upcoming",
      "description": "上海车展官方入口，按 2027 年媒体日窗口开始倒计时；具体车型首发以车展和品牌官方后续公告为准。",
