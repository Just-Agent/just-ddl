...
export const ddlData: Record<string, DDLItem[]> = {
  ...
  "sports-ddl": [
    ...
    },
    {
      ...
      "isOnline": false,
      "tags": ["乒乓球", "ATTU", "Asian Championships"],
      "url": "https://www.ittf.com/2026-events-calendar/",
      "status": "upcoming",
    ...
    },
    {
      ...
      "location": "Sydney, Australia",
      "isOnline": false,
      "tags": ["马拉松", "World Marathon Majors", "road race"],
