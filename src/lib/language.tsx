...
const dictionary = {
  zh: {
    ...
    my: {
      ...
      personal: '个人添加',
      items: '个 DDL',
      pageHint: '收藏专题会把整个专题流加入这里；收藏某个事件只加入那一条 DDL；个人 DDL 只保存在当前浏览器。',
      organizeLabel: '组织方式',
      displayLabel: '展示方式',
      byTopic: '按专题折叠',
      byTime: '按时间交叉',
  ...
  en: {
    ...
    my: {
      ...
      personal: 'plus',
      items: 'DDL items',
      pageHint: 'Saving a topic brings the whole topic stream here; saving one event adds only that single deadline; personal DDL stays in this browser.',
